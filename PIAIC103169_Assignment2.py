 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    arr = np.array([1,2,3])\n",
    "    ans = np.array(np.stack([np.full(arr.size, arr[0]),np.full(arr.size, arr[1]),np.full(arr.size, arr[2]),arr,arr,arr])).flatten() #write your code here \n",
    "  \n",
    "    return ans\n",
    "\n",
    "    \"\"\"\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    ans = np.array(arr[arr > 5])[np.array(arr[arr > 5])<10]#write your code here \n",
    "  \n",
    "    return ans\n",
    "\n",
    "    \"\"\"\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    x = np.array(np.where(students[:, None] == piaic[None, :])[1]).size# Write you code Here\n",
    "    return x\n",
    "\n",
    "    #Expected output: 3"
   ]
